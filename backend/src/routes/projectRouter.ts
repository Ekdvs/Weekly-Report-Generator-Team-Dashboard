...
// Writes — manager only
projectRouter.post("/",managerOnly,validate(createProjectSchema as never),createProjectController)
projectRouter.put("/:id",managerOnly,validate(updateProjectSchema as never),updateProjectByIdController)
projectRouter.delete("/:id",managerOnly,validate(projectIdParamSchema as never),deleteProjectByIdController)

projectRouter.post("/:id/members",managerOnly,validate(assignMemberSchema as never), assignMemberController)
projectRouter.delete("/:id/members/:userId",managerOnly,validate(removeMemberSchema as never),removeMemberController)
