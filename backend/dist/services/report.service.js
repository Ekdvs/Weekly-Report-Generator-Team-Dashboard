...
const isLateSubmission = (weekEnd, submittedAt) => {
...
//create project
export const createReport = async (userId, input) => {
...
export const getReportForRequester = async (id, requesterId, requesterRole) => {
...
// update the report
export const updateReport = async (id, requesterId, input) => {
    const report = await getReportOr404(id);
...
// submit the report
export const submitReport = async (id, requesterId) => {
    const report = await getReportOr404(id);
    if (report.userId !== requesterId) {
...
export const getMyReports = async (userId, query) => {
...
export const listAllReports = async (query) => {
